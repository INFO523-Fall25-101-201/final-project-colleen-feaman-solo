...
-   For `books.csv`, I removed invalid publication years, rows with missing values for `Book_Author` and `Publisher`, any books published by Scholastic or Random House Books for Young Readers (kids books), and known foreign-language publishers. I was not able to interpret the quality of recommendations when all the book titles were in German.

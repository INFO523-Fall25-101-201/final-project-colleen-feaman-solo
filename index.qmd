...
description: "A hybrid book recommendation system that combines a content-based and collaborative filter model using publicly availble book metadata and user reading history."
format:
   html:
    code-tools: true
    code-overflow: wrap
